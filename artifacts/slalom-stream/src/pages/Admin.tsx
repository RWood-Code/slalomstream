...
import { Settings, Shield, UserPlus, Radio, CheckCircle2, XCircle, Copy, RefreshCw, Trash2, Key } from 'lucide-react';
              ...
              <div className="p-4 bg-muted/50 rounded-xl border">
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono font-bold">{wscStatus?.inbound_count ?? 0}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Last inbound</span>
                    <span className="font-mono text-xs">
                      {wscStatus?.last_inbound?.ts
                        ? new Date(wscStatus.last_inbound.ts).toLocaleTimeString()
                        : 'Never'}
                    </span>
                  </div>
                </div>
